...
// Stopwatch functionality. Determines the number of microseconds since the timer was started.
uint64_t SWTimer_elapsedTimeUS(SWTimer* timer_p);

// Determines the percentage of time elapsed before expiration. When the timer
// is started, the value is 0.0, and as time elapses, the value rises to 1.0.
